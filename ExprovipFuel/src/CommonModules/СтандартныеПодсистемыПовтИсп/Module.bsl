...
// Возвращаемое значение:
//  Булево - если истина, тогда режим совместимости конфигурации 8.3.20 или выше.
//
Функция ТипВсеСсылкиПоддерживаетсяДляОбъектовРасширений() Экспорт
	...
	Если ТекущийРежим = Метаданные.СвойстваОбъектов.РежимСовместимости.НеИспользовать Тогда
		...
		ТекущийРежимСтрокой = СтрЗаменить(ВерсияПлатформы, ".", "_");
	Иначе
	...
	Если СтрЗаканчиваетсяНа(ТекущийРежимСтрокой, "8_3_14")
	 ...
	 Или СтрЗаканчиваетсяНа(ТекущийРежимСтрокой, "8_3_19") Тогда
