...
Функция СоздатьФайлСВерсией(ВладелецФайла, СведенияОФайле) Экспорт
	...
	Попытка
		...
		Если Не ЗначениеЗаполнено(СведенияОФайле.Кодировка) Тогда
			СведенияОФайле.Кодировка = РегистрыСведений.КодировкиФайлов.КодировкаДвоичныхДанных(СведенияОФайле.АдресВременногоХранилищаФайла, СведенияОФайле.РасширениеБезТочки);
		КонецЕсли;
