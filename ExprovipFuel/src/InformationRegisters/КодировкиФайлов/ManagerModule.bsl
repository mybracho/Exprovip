...
Функция ОпределитьКодировкуФайла(ПрисоединенныйФайл, Расширение) Экспорт
	...
	Возврат КодировкаДвоичныхДанных(ДвоичныеДанные, Расширение);
...
// 
// Возвращаемое значение:
//  Строка - Кодировка двоичных данных
Функция КодировкаДвоичныхДанных(ДанныеДляАнализа, Расширение) Экспорт
