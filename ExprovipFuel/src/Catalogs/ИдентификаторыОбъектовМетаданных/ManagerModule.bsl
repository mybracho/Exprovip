...
Процедура ДобавитьСвойстваОбъектовМетаданных(Знач КоллекцияОбъектовМетаданных,
	...
	ТипВсеСсылкиПоддерживается = ?(Не ОбъектыРасширений, Истина,
		СтандартныеПодсистемыПовтИсп.ТипВсеСсылкиПоддерживаетсяДляОбъектовРасширений());
