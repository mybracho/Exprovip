...
Функция ИННСоответствуетТребованиям(Знач ИНН, ЭтоЮридическоеЛицо, ТекстСообщения) Экспорт
	...
	Если  ЭтоЮридическоеЛицо И ДлинаИНН <> 10 И ДлинаИНН <> 5 Тогда
		СоответствуетТребованиям = Ложь;
	...
	Если Лев(ИНН, 2) = "00" И ДлинаИНН <> 5 Тогда
		СоответствуетТребованиям = Ложь;
		ТекстСообщения = ТекстСообщения
			+ НСтр("ru = 'Первый и второй знаки ИНН не могут одновременно принимать значение ""0"".'");
	ИначеЕсли ИНН = "00000" Тогда
		СоответствуетТребованиям = Ложь;
		ТекстСообщения = ТекстСообщения
			+ НСтр("ru = 'Все знаки кода иностранной организации одновременно не могут принимать значение ""0"".'");
	КонецЕсли;
